...
class Ui_FitsHeaderWindow(object):
    ...
    def retranslateUi(self, FitsHeaderWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("FitsHeaderWindow", "Tab 1"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("FitsHeaderWindow", "Tab 2"))
